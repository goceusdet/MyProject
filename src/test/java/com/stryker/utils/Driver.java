            ...
            switch (browserType) {
                /*case "remote-chrome":
                    try {
                        ...
                        String gridAddress = "Server IP address here";
                        URL url = new URL("http://" + gridAddress + ": + Server-Port-ID -Here + ]/wd/hub");
                        DesiredCapabilities desiredCapabilities = new DesiredCapabilities();
                        desiredCapabilities.setBrowserName("chrome");
                        driverPool = new RemoteWebDriver(url, desiredCapabilities);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    break;
